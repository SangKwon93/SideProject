...
def merge_music(musics, likes={}, albums={}): #{} 매개변수 기본값
    ...
    for music in musics.values():
        the_key = music['index']
        # detail_music = music # 원시값, 참조값 a = 3, b = a,  b = 4 , print(a) 
        # detail_music['likes'] = likes.get(the_key) # detail_music -> music, musics
        #detail_music = {**music} # need copy **music { a: music.a, b: music.b}
        # { autore: {name, music}, }
...
# # def main():
# #     musics = get_musics() # { 1: {name, title, albumId, }}
# #     likes = get_likes(musics) # { 1 : 4311, 2: 321}
# #     albums = get_albums(musics) # { 1 : {}, 2: {}, 3: {}
# #     detail_musics = concat(musics, likes, albums)
